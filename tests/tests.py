...
class MockFetcher(object):
    state = {"headers": {"foo": "bar"}, "cookies": {"qwerty": "123456"}}

    def fetch(self, url, headers={}):
        url = re.subn(r"[^0-9a-z]", "-", url, flags=re.IGNORECASE)[0]
...
class ParsersTest(unittest.TestCase):
    ...
    def test_series_index_parser(self):
        ...
        self.assertEqual(
            data["Black Mirror"], "http://www.tusubtitulo.com/show/1168"
        )
    ...
    def test_season_page_parser(self):
        ...
        self.assertTrue(
            (
                ...
                "http://www.tusubtitulo.com/updated/5/47505/2",
            )
            in data
        )
...
class APITest(unittest.TestCase):
    ...
    def test_exact_match(self):
        ...
        self.assertEqual(
            info.url, tusubtitulo.SERIES_PAGE_PATTERN.format(show="1168")
        )
